...
import { Plus, Search, Building2, Users, Calendar, ChevronRight, Loader2 } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const stats = {
    ...
    live: tenants.filter(t => t.onboarding_status === 'live').length,
    onboarding: tenants.filter(t => !['live', 'pending'].includes(t.onboarding_status)).length,
    pending: tenants.filter(t => t.onboarding_status === 'pending').length,
  };
    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage gym accounts and onboarding</p>
        </div>
        <button
          ...
          <div className="divide-y divide-gray-200">
            {filteredTenants.map((tenant) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-medium ${statusColors[tenant.onboarding_status] || statusColors.pending}`}>
      ...
      <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Tenant Created!</h2>
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-1">Set up a new gym account</p>
        </div>
