                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-green-900">Connection Status</span>
                      <CheckCircle className="text-green-600" size={20} />
                    </div>
                    <p className="text-2xl font-bold text-green-900">Connected</p>
                    <p className="text-xs text-green-700 mt-1">Company: {location === 'athletic-club' ? 'The Lab Tampa - Athletic' : 'The Lab Tampa - Dance'}</p>
                  </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">CRM Category</th>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">QuickBooks Account</th>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">QuickBooks Item</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {accountMappings.map((mapping, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          <td className="px-4 py-3 text-sm font-medium text-gray-900">{mapping.category}</td>
                          <td className="px-4 py-3 text-sm text-gray-600">{mapping.qbAccount}</td>
                          <td className="px-4 py-3 text-sm text-gray-600">{mapping.qbItem}</td>
